...
// 4 items flanking the centre "+" button
const mobileNavLeft  = [
  { name: "Dashboard", href: "/dashboard", icon: LayoutDashboard },
  { name: "Journal",   href: "/journal",   icon: Table2 },
];
...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <SidebarProvider>
      ...
      <nav
        className="lg:hidden fixed bottom-0 inset-x-0 z-50 h-16 bg-background/95 backdrop-blur-sm border-t border-border flex items-stretch"
